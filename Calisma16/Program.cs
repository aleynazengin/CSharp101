...
namespace Calisma16
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(DateTime.Now.Date); //saat hariç tarihi getirir
            ...
            Console.WriteLine(DateTime.Now.ToLongDateString()); //yazı halinde tarih
            Console.WriteLine(DateTime.Now.ToShortDateString()); //8.06.2021
            Console.WriteLine(DateTime.Now.ToLongTimeString()); //22:32:53
            Console.WriteLine(DateTime.Now.ToShortTimeString()); //22:32
